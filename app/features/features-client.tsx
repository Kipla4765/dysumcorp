            ...
            <main>
                ...
                <section className="py-16 lg:py-24 px-4 sm:px-6 bg-stone-100">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <Stagger className="grid grid-cols-1 lg:grid-cols-3 gap-8" delay={0.1}>
                            {coreFeatures.map((feature, index) => (
                                <StaggerItem key={index}>
                                    <div
                                        className={`p-8 sm:p-10 rounded-[2.5rem] border flex flex-col h-full premium-shadow-hover relative ${feature.dark
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 ${feature.dark ? "bg-white/10" : "bg-stone-100"
                                                }`}
                                        >
                                            <feature.icon
                                        ...
                                        <div
                                            className={`inline-block text-[10px] font-bold uppercase tracking-[0.2em] px-3 py-1 rounded-full mb-4 ${feature.dark
